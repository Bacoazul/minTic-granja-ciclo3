 ...
 */
@Controller
public class ManejadorCierreSesion extends SecurityContextLogoutHandler {
     ...
     */
    @Autowired
    public ManejadorCierreSesion(ClientRegistrationRepository clientRegistrationRepository) {
